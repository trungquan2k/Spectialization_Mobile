    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.content}>
            ...
            {ViewDetail("SOR Quantity Record Job",route.route.params.item.job)}
        ...
        <View style={styles.payItemDetail}>
            {
                route.route.params.item.payDetail.map((value) => {
        ...
        {/* {console.log(ViewPayItemDetail(value))} */}
        {/* {console.log(route.route.params.item.payDetail.map((value) => (value)))} */}
      </ScrollView>
    );
  }
